...
function ProductList({ onHomeClick }) {
    ...
    const [addedToCart, setAddedToCart] = useState({}); // Tracks which plants have already been added
        ...
        },
        {
            ...
            plants: [
                ...
                },
                {
                    ...
                    description: "Well known for repelling mosquitoes outdoors.",
                    cost: "$13"
                },
                {
                    name: "Catnip",
        ...
        },
        {
            ...
            plants: [
                ...
                },
                {
                    name: "Lemon Grass",
                    image: "https://cdn.pixabay.com/photo/2016/07/24/20/48/tulsi-1539181_1280.jpg",
                    description: "Eases pain, aids digestion, and helps with anxiety.",
                    cost: "$11"
                },
                {
                    name: "Turmeric",
                    image: "https://cdn.pixabay.com/photo/2017/07/12/12/23/peppermint-2496773_1280.jpg",
                    description: "Anti-inflammatory root used to relieve pain and boost immunity.",
                    cost: "$14"
                }
            ]
        },
        {
            ...
            plants: [
                ...
                },
                {
                    name: "Dracaena",
                    image: "https://cdn.pixabay.com/photo/2020/02/15/11/49/flower-4850729_1280.jpg",
                    description: "A hardy, slow-growing plant that thrives on neglect.",
                    cost: "$19"
                }
            ]
        }
    ...
    const handlePlantsClick = (e) => {
        e.preventDefault();
        setShowCart(false); // Go back to the product listing view
    };
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    <div><a href="#" onClick={(e) => handleHomeClick(e)} style={styleASmall}>Home</a></div>
